...
def askisi9():
    ...
    OSO TO DYNATON LIGOTERES GRAMMES """
    from math import pi
    ...
    print_sequence(10, lambda r: 2*pi*r)
    print('Emvada tetragwnwn me pleura 1 ews 8')
    print_sequence(8, lambda x: x**2)
    print_sequence(5, lambda r: 'Emvado kyklou aktinas ' \
                   + str(r) + ' = ' + str(pi * r**2))
